...
export class NodeView implements FramableView, ISelectableView {
    
    bounds: Rectangle;
    labelBounds: Rectangle;
    collapseArrowCenter: NewType;
    fullWidth = 200;
    isSelected = false;
    ...
    findConnector(position: Point, style: IStyleDimension): NodePropertyView {
    ...
    private drawNodeFull(editor: IEditor) {
    ...
    private drawNodeCollapsed(editor: IEditor) {
        const renderer = editor.renderer;
        const style = renderer.style;
