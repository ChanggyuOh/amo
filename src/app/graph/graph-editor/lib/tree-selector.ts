...
import { IUiNode } from "./models/i-ui-node";
import { Selector } from "./selector";
import { collectLeaves, ITreeNode } from "./models/i-tree-node";

export class TreeSelector extends Selector {
    private inputElement: HTMLInputElement;
    private listEl: HTMLUListElement; 
    private leaves: ITreeNode[] = [];
    private current: IUiNode[] = [];
    private selection = -1;
    private nodes: IUiNode[];
    ...
    private selectItem(node: IUiNode, index: number, next: number) {
